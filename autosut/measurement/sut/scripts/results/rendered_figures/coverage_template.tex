...
\begin{tikzpicture}[x=0.50cm,y=0.028cm,font=\scriptsize]
  ...
  \node[above,font=\scriptsize] at (1.4,100.0) {100};
  \node[above,font=\scriptsize] at (2.3,68.2) {68.2};
  \node[above,font=\scriptsize] at (3.2,2.70) {2.3};
  \fill[acmBlue]   (4.0,0) rectangle (4.8,100.0);
  \fill[acmTeal]   (4.9,0) rectangle (5.7,87.1);
  \fill[acmSand]   (5.8,0) rectangle (6.6,0.0);
  \node[above,font=\scriptsize] at (4.4,100.0) {100};
  \node[above,font=\scriptsize] at (5.3,87.1) {87.1};
  \fill[acmBlue]   (7.0,0) rectangle (7.8,98.8);
  \fill[acmTeal]   (7.9,0) rectangle (8.7,80.7);
  \fill[acmSand]   (8.8,0) rectangle (9.6,1.2);
  \node[above,font=\scriptsize] at (7.4,98.8) {98.8};
  \node[above,font=\scriptsize] at (8.3,80.7) {80.7};
  \node[above,font=\scriptsize] at (9.2,1.70) {1.2};
  ...
  \node[above,font=\scriptsize,text=gray] at (11.3,2) {0};
  \fill[acmBlue]   (13.0,0) rectangle (13.8,100.0);
  \fill[acmTeal]   (13.9,0) rectangle (14.7,63.1);
  \fill[acmSand]   (14.8,0) rectangle (15.6,1.2);
  \node[above,font=\scriptsize] at (13.4,100.0) {100};
  \node[above,font=\scriptsize] at (14.3,63.1) {63.1};
  \node[above,font=\scriptsize] at (15.2,1.70) {1.2};

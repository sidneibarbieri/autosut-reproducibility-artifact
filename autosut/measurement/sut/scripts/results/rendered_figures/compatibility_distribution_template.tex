...
\begin{tikzpicture}[x=0.603cm,y=0.055cm,font=\footnotesize]
  ...
  \node[anchor=west,font=\scriptsize,text=acmGray] at (5.18,42.45) {fallback 67.3\%};
  ...
  \node[below,font=\scriptsize,text=gray,align=center] at (4.35,-7.0) {61 explicit\\465 fallback};
  ...
  \node[below,font=\scriptsize,text=gray] at (4.35,-18.0) {$N=691$ techniques};
\end{tikzpicture}

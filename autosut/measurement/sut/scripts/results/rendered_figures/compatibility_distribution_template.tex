...
\begin{tikzpicture}[x=0.603cm,y=0.055cm,font=\small]
  ...
  \node[anchor=west,font=\scriptsize,text=acmGray] at (5.35,42.45) {fallback 67.3\%};
  ...
  \node[font=\scriptsize,text=black!70,align=center] at (6.9,-29.5) {Compatibility class / sensitivity\\$N=691$ techniques};
\end{tikzpicture}

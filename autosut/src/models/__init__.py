...
class ExecutionMode(str, Enum):
    ...
    The first three modes were defined by the original AutoSUT scaffold; the
    last two were added in S7/S8/S9 when AutoSUT gained a live MITRE Caldera
    backend. They are kept in sync with the orchestrator's own ExecutionMode
    enum at ``scripts/orchestrator/models.py``.
    """

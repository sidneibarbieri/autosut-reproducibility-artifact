...
- Generated at: `2026-05-31T10:12:35`
- Campaigns measured: `19`
- Total tagged SUT elements: `130`
- Policy: 3-category hybrid (`corpus_supported` / `autosut_concretized` / `analyst_authored`).

Of the **130** concrete SUT elements materialised across **19** campaign SUT profiles, **24.6%** is anchored in the CTI corpus, **17.7%** is an AutoSUT concretization of an under-specified corpus signal, and **57.7%** is an explicit analyst lab choice the corpus does not constrain.
...
| Artifacts | 0 | 0 | 29 | 29 |
| Topology | 0 | 0 | 3 | 3 |
| **All** | 32 (24.6%) | 23 (17.7%) | 75 (57.7%) | **130** |
...
| `0.c0011` | 6 | 1 (16.7%) | 1 (16.7%) | 4 (66.7%) |
...
| `0.caldera_linux_demo` | 6 | 1 (16.7%) | 1 (16.7%) | 4 (66.7%) |
| `0.fin6_emulation` | 6 | 1 (16.7%) | 1 (16.7%) | 4 (66.7%) |
